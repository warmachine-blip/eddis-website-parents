...
const commonInjuries = [
  "Cervical and lumbar whiplash",
  "Facet-mediated neck pain",
  "Post-concussive headache",
  "Cervicogenic headache",
  "Disc herniation",
  "Post-traumatic radicular pain",
];

const whatToExpect = [
  "Detailed accident-history intake",
  "Targeted exam and imaging review",
  "Stepwise diagnostic-and-treatment plan",
...
export default function MotorVehicleInjuriesPage() {
  return (
    <div>
      {/* Hero */}
            ...
            <div className="grid gap-12">
              <div>
                <SectionHeading
                  ...
                  title="Don't underestimate the cervical spine."
                  lead="Even at relatively low speeds, motor-vehicle collisions can generate significant force on the cervical spine and head. Whiplash, post-concussive headache, and facet-mediated neck pain frequently emerge in the days and weeks following an accident — long after the ER discharge."
                />
                <p className="mt-4 text-base leading-relaxed text-charcoal-soft">
                  Our approach: a careful re-evaluation of symptoms, targeted imaging where
                  indicated, and a stepwise interventional plan designed around your
              ...
              <SectionHeading
                ...
                title="Documentation that supports your case."
