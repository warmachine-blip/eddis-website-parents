...
/** One list for every place social links render (header reveal, footer). */
export const socialItems = [
  ...
  { key: "linkedin", label: "Edward Baumgartner Jr., MD on LinkedIn", Icon: LinkedInIcon, href: linkedInUrl },
] as const;
